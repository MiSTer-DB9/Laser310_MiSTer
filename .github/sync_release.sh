...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Laser310_MiSTer.git"
CORE_NAME=(Laser310)
...
UPSTREAM_CORE_NAME=(Laser310)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Laser310.qpf)
COMPILATION_OUTPUT=(output_files/Laser310.rbf)
